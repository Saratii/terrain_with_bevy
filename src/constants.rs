...
pub const GROUND_HEIGHT: usize = (GRID_HEIGHT as f32 * 0.2) as usize;
pub const ROCK_HEIGHT: usize = (GRID_HEIGHT as f32 * 0.4) as usize;
pub const SKY_HEIGHT: usize = (GRID_HEIGHT as f32 * 0.4) as usize;
...
pub const CURSOR_ORBITAL_RADIUS: f32 = 100.;
pub const CURSOR_RADIUS: usize = 15;
