...
pub fn left_click_shovel(shovel_position: &Transform, shovel_contents: &mut Vec<u8>, chunk_map: &mut Vec<Vec<u8>>, gravity_coords: &mut GravityCoords, shovel_grid: &mut Vec<u8>) {
